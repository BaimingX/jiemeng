                        ...
                        if (isGuestUser && !isMobilePlatform) {
                            return new Response(
                                JSON.stringify({
                                    ...
                                    message: 'Anonymous access is limited to mobile apps. Please sign in to continue.',
                                }),
                            ...
                            if (!deviceId) {
                                return new Response(
                                    JSON.stringify({
                                        ...
                                        message: 'Please update the app to continue using the free trial.',
                                    }),
                                    { status: 400, headers: jsonHeaders }
                                )
                            }
                            ...
                            if (!deviceStatus.allowed) {
                                ...
                                return new Response(
                                    JSON.stringify({
                                        ...
                                        message: 'Free trials are used up. Please subscribe to continue.',
                                        trial_remaining: 0
                                    }),
