...
-- Tracks free trial usage (3 free AI dream interpretations)
...
COMMENT ON TABLE public.billing_trials IS 'Free trial usage tracking. Default 3 free uses per user.';
